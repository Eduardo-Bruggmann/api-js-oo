...
import { getBook, updateBook } from '../../api/books.api.js'
import { navigate } from '../../router.js'

export async function renderEditBookPage(id) {
  ...
  try {
    ...
    renderForm(book, authorsResponse.data)
  } catch (error) {
    app.innerHTML = `
      <main class="mx-auto max-w-2xl px-4 py-8">
...
function renderForm(book, authors) {
  const app = document.querySelector('#page')
